...
class HomePageTest(FunctionalTest):
    ...
    def test_home_page_contains_tabbed_form(self):
        ...
        # Beneath both previous tabs Alfrescan sees one form
        # -either Alfresco or Activiti-
        ...
        actual_headers = self.browser.\
            find_elements_by_css_selector('.panel h3 b')
        expected_headers = [
    ...
    def test_home_page_has_tabs_to_change_visible_form_content(self):
        default_content = self.browser.find_element_by_css_selector(
            'div.active .panel'
        )
