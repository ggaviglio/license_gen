...
from sys import getsizeof       ## This is for the generate file I have to create
...
def generate_license(request):
    ...
    try:
        if request.POST.get('alfresco_generate_btn'):
            ...
            alfresco_data['field_days'] = request.POST.get('field_days')
            alfresco_data['field_max_users'] = request.POST.get('field_max_users')
            ...
            alfresco_data['field_max_docs'] = request.POST.get('field_max_docs')
            ...
            activiti_data['field_number_of_admins'] = request.POST.get('field_number_of_admins')
            activiti_data['field_number_of_editors'] = request.POST.get('field_number_of_editors')
            ...
            activiti_data['field_number_of_licenses'] = request.POST.get('field_number_of_licenses')
            activiti_data['field_number_of_processes'] = request.POST.get('field_number_of_processes')
